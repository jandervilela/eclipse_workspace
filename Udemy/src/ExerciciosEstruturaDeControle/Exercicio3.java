...
public class Exercicio3 {
	/**
	 * 3. Criar um programa que receba duas notas parciais, calcular a meÌdia
	 ...
	 * "RecuperacÌ§aÌƒo", caso contraÌrio imprime no console "Reprovado".
	 */
	...
	public static void main(String[] args) {
		...
		if (media >= 7) {
			...
			System.out.println("Sua média foi " + media + " e você está de RecuperaÃ§Ã£o.");
		} else {
